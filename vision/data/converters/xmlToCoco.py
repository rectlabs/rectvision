...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="xml annotation to coco data json file."
    )
    parser.add_argument(
        "xml_annotation",
        help="Directory to images and xml annotation files.",
        type=str,
    )
    parser.add_argument(
        "--description", help="Name of project.", type=str, default="Generated by RectangleAI"
    )
    parser.add_argument(
    ...
    xml_to_coco(args.xml_annotation, args.output, args.description)