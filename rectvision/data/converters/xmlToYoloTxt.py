...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='XML annotation to yolo text annotation files'
    )
    ...
    xml_to_yoloTxt(args.label_to_id_file_path, args.annotation_dir, args.output_txt_dir)
